...
func (x *PurchaseMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PurchaseMessage) ProtoMessage() {}

func (x *PurchaseMessage) ProtoReflect() protoreflect.Message {
	mi := &file_purchase_proto_msgTypes[0]
...
// Deprecated: Use PurchaseMessage.ProtoReflect.Descriptor instead.
func (*PurchaseMessage) Descriptor() ([]byte, []int) {
	return file_purchase_proto_rawDescGZIP(), []int{0}
}

func (x *PurchaseMessage) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PurchaseMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PurchaseMessage) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
var file_purchase_proto_rawDesc = []byte{
	...
	0x22, 0x51, 0x0a, 0x0f, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x4d, 0x65, 0x73, 0x73,
	...
	0x65, 0x74, 0x65, 0x42, 0x2c, 0x5a, 0x2a, 0x64, 0x61, 0x6d, 0x69, 0x65, 0x6e, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x72, 0x69, 0x73, 0x6b, 0x2d, 0x61, 0x73, 0x73, 0x65, 0x73, 0x73, 0x6d, 0x65, 0x6e,
	0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73,
...
var file_purchase_proto_goTypes = []interface{}{
	(*PurchaseMessage)(nil), // 0: PurchaseMessage
}
